...
public:
	...
	bool DrawRectangle(const SDL_Rect& rect, b2Color col, bool filled, bool use_camera, SDL_BlendMode blendMode = SDL_BLENDMODE_BLEND) const;
	...
	bool DrawText(const std::string& text, int posX, int posY, int w, int h, bool isDialogue = false, SDL_Color col = SDL_Color{ 255,255,255,255 }, TextAlingment aligment = LEFT_ALIGN, int maxLineLength = 60);
